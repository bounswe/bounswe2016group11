...
public class Melih extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<body>");
		if (my_query == null){out.println("<form action='Melih' method='get'> ASdasdffDAsdafFFPasflease enter a query:<br><input type='text' name='my_query'><br><br><input type='submit' value='Submit'></form>");}
